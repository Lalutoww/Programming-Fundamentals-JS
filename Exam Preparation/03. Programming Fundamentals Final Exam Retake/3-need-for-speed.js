function needForSpeed(input){
        ...
        switch(command){
            ...
            case 'Refuel':
                ...
                if(carStorage[carName].fuel + refuel > 75){
                    console.log(`${carName} refueled with ${75 - carStorage[carName].fuel} liters`);
    ...
    for (const car in carStorage) {
        console.log(`${car} -> Mileage: ${carStorage[car].mileage} kms, Fuel in the tank: ${carStorage[car].fuel} lt.`);
    }
}
needForSpeed( [
    '4',
