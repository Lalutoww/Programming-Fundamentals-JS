        ...
        switch(command){
            ...
            case 'Error':
                ...
                if(errorIndex <= usernames.length - 1 && errorIndex > -1){
                    if(usernames[errorIndex] !== 'Blacklisted' && usernames[errorIndex] !== 'Lost'){
                        console.log(`${usernames[errorIndex]} was lost due to an error.`);
            ...
            case 'Change':
                ...
                if(changeIndex <= usernames.length - 1 && changeIndex > -1){
                    console.log(`${usernames[changeIndex]} changed his username to ${newName}.`);
