function experienceGaining(input) {
  //Collecting input data
    ...
    for(let i = 1; i <= countOfBattles; i++){
        if (i % 3 === 0) {
            totalExperience += experienceEarnedPerBattle + (experienceEarnedPerBattle * 0.15);
          }
          if (i % 5 === 0) {
    ...
    //Print output
  if (hasCollected) {
    console.log(`Player successfully collected his needed experience for ${battlesNeeded} battles.`);
  } else {
